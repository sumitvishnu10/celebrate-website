      ...
      <div className="container navbar-container">
        <div className="navbar-logo">
          <div className="logo-text-wrapper">
            <h2 className="logo-text-main">Celebrate</h2>
            <Sparkles className="logo-sparkle" size={24} fill="#E5B869" color="#E5B869" />
          </div>
          <span className="logo-subtitle">Perfect Events. Perfectly Planned.</span>
        </div>
